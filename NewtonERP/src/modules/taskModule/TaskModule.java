...
public class TaskModule extends Module {
    ...
    private static void intiDynamicFieldTask() {
        ...
        fieldEntity = (EntityEntity) Orm.getInstance()
                .selectUnique(fieldEntity);

        SearchCriteriaOperator equals = new SearchCriteriaOperator();
        equals.setData("name", "=");
        equals = (SearchCriteriaOperator) Orm.getInstance()
                .selectUnique(equals);
    ...
    private static void initInvoiceLineTask() {
        ...
        invoiceLineEntity = (EntityEntity) Orm.getInstance().selectUnique(
                invoiceLineEntity);
    ...
    private static void initShippingTask() {
        ...
        shippingEntity = (EntityEntity) Orm.getInstance().selectUnique(
                shippingEntity);
    ...
    private static void initInvoiceTaxLineTask() {
        ...
        invoiceTaxLineEntity = (EntityEntity) Orm.getInstance().selectUnique(
                invoiceTaxLineEntity);
