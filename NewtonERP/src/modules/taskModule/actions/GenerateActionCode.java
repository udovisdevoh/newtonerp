...
public class GenerateActionCode extends AbstractAction {
	...
	private void createRights(ActionEntity actionEntity) {
		...
		for(String entityName : entityList){
			GenerateEntityCode.createRightIfNotExist(moduleName, entityName, actionName);
		}
	}
	...
	{
		PluralAccessor entityEntityList = moduleEntity.getPluralAccessor(new EntityEntity().getSystemName());
