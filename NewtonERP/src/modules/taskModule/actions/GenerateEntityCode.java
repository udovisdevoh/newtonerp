...
public class GenerateEntityCode extends AbstractAction {
	...
	{
		PluralAccessor actionEntityList = moduleEntity.getPluralAccessor(new ActionEntity().getSystemName());
	 ...
	 */
	public static void createRightIfNotExist(String moduleName, String entityName, String actionName) {
