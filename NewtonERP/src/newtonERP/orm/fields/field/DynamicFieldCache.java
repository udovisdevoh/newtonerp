...
/**
 * Cache pour accélérer les dynamic field (Ce cache conserve les entité de fields dynamiques)
 * 
...
public class DynamicFieldCache {
	 ...
	 */
	public static Vector<AbstractOrmEntity> tryGetDataForEntity(String entityName) {
