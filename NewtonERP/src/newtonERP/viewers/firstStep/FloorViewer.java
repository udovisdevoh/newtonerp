...
public class FloorViewer {
	...
	public static String getHtmlCode(FloorViewable entity) {
		...
		for(int y = 0; y < entity.getRowCount(); y++){
			...
			for(int x = 0; x < columnCount; x++){
				...
				html += "<td style=\"width:" + (internalZoneSize + wallWidth * 2) + "px;height:"
				        + (internalZoneSize + wallWidth * 2) + "px\">";

				html += getRoomHtml(currentText, currentColor, entity, x, y, isCorridor);
	...
	private static String getRoomHtml(String currentText, String backgroundColor, FloorViewable entity, int x, int y,
	        boolean isCorridor) {
		String html = "";
		...
		html += "<td style=\"height:" + wallWidth + "px;width:" + wallWidth + "px;background-color:" + noWallColor
		        + "\"><div></div></td>";
		html += "<td style=\"height:" + wallWidth + "px;background-color:" + northWestColor + "\"><div></div></td>";
		html += "<td style=\"height:" + wallWidth + "px;background-color:" + northEastColor + "\"><div></div></td>";
		html += "<td style=\"height:" + wallWidth + "px;width:" + wallWidth + "px;background-color:" + noWallColor
		        + "\"><div></div></td>";
		...
		html += "<td style=\"height:32px;width:" + wallWidth + "px;background-color:" + westNorthColor
		        + "\"><div></div></td>";
		html += "<td colspan=\"2\" rowspan=\"2\" ><div style=\"width:" + internalZoneSize + "px;height:"
		        + internalZoneSize + "px;overflow:auto;background-color:" + backgroundColor + "\">";
		html += currentText;
		...
		html += "</div></td>";
		html += "<td style=\"height:32px;width:" + wallWidth + "px;background-color:" + eastNorthColor
		        + "\"><div></div></td>";
		...
		html += "<td style=\"height:32px;width:" + wallWidth + "px;background-color:" + westSouthColor
		        + "\"><div style=\"height:32px;width:" + wallWidth + "px\"></div></td>";
		html += "<td style=\"height:32px;width:" + wallWidth + "px;background-color:" + eastSouthColor
		        + "\"><div style=\"height:32px;width:" + wallWidth + "px\"></div></td>";
		...
		html += "<td style=\"height:" + wallWidth + "px;width:" + wallWidth + "px;background-color:" + noWallColor
		        + "\"><div></div></td>";
		html += "<td style=\"height:" + wallWidth + "px;background-color:" + southWestColor + "\"><div></div></td>";
		html += "<td style=\"height:" + wallWidth + "px;background-color:" + southEastColor + "\"><div></div></td>";
		html += "<td style=\"height:" + wallWidth + "px;width:" + wallWidth + "px;background-color:" + noWallColor
		        + "\"><div></div></td>";
