 ...
 */
public class ScrollList extends newtonERP.module.AbstractEntity implements newtonERP.viewers.viewables.ScrollListViewable {
  private String title;

  private String, String linkList;

  private newtonERP.common.NaturalMap linkPairList;

  private String titleUrl;

  private newtonERP.common.ActionLink actionLinkList;
  ...
  public newtonERP.common.NaturalMap getLinkGroupList() {
   ...
   */
  public void addLinkGroup(String link1Name, String link1Url, String link2Name, String link2Url) {
