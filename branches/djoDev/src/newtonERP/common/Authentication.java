...
/**
 * Cette classe sert à authentifier un user de manière hardcodée OU par session
 * HTTP Le but de cette classe est d'être gérée par le code qui manipulera les
 * sessions HTTP
 * 
