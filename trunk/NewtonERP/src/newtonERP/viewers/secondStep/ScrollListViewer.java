...
public class ScrollListViewer {
...

	{
		...
		html += "<div class=\"scrollableDivPair\" style=\"border-color:" + ColorViewer.getColor(entity.getTitle())
		        + "\"><div>";
		...
		for(String linkName : entity.getLinkList().keySet()){
			html += "<li><a href=\"" + entity.getLinkList().get(linkName) + "\">" + linkName + "</a></li>";
		}
		...
		for(NaturalMap<String, String> linkPair : entity.getLinkGroupList()){
			...
			for(String linkName : linkPair.getKeyList()){
				...
				html += "<a href=\"" + linkPair.get(linkName) + "\"" + styleModifier + ">" + linkName + "</a>";
