...
public class SwitchViewer {
	 ...
	 */
	public static String getHtmlCode(String keyName, String labelName, boolean isChecked) {
		String html = "";
		...
		html += "oui: <input type=\"radio\" name=\"" + keyName + "\" value=\"true\"" + yesIsChecked + ">";
		html += " | non: <input type=\"radio\" name=\"" + keyName + "\" value=\"false\"" + noIsChecked + ">";
