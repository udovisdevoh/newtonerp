...
/**
 * @author BeeERP team Représente tous les SGBD et leurs implémentations et déclatations communes
 */
public abstract class AbstractSgbd {
	/**
	 * Method that executes the sql query passed in paramter plus de action from the OrmAction
	 * 
	 ...
	 * @param entityContainingChanges the changes to apply
	 */
	public abstract void updateUnique(AbstractOrmEntity searchEntity, AbstractOrmEntity entityContainingChanges);
