...
public class CheckForWorkOrders extends AbstractAction
{
			...
			Hashtable<String, String> parameters) throws Exception
	{
		...
		if ((Integer) product.getData("quantityInStock") >= 0)
		{
			...
			else
			{
				...
				if ((Integer) product.getData("quantityInStock") < (Integer) product
						...
						&& ((Integer) product.getData("quantityInStock") + inProduction) < (Integer) product
								.getData("reorderPoint"))
				{
					...
					// TODO : Delete me after testing if not Wo with less than
					// zero
					// quantities
					// if (toProduce > 0)
					// {
		...
		{
			// TODO : Add an alert message on the current product page?
		}
